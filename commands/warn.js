...
async function warnCommand(sock, chatId, senderId, mentionedJids, message) {
    try {
        ...
        try {
            ...
            const warningMessage = `*『 𝚆𝙰𝚁𝙽𝙸𝙽𝙶 𝙰𝙻𝙴𝚁𝚃 』*\n\n` +
                `👤 *𝚆𝚊𝚛𝚗𝚎𝚍 𝚄𝚜𝚎𝚛:* @${userToWarn.split('@')[0]}\n` +
                `⚠️ *𝚆𝚊𝚛𝚗𝚒𝚗𝚐 𝙲𝚘𝚞𝚗𝚝:* ${warnings[chatId][userToWarn]}/3\n` +
                `👑 *𝚆𝚊𝚛𝚗𝚎𝚍 𝙱𝚢:* @${senderId.split('@')[0]}\n\n` +
            ...
            if (warnings[chatId][userToWarn] >= 3) {
                ...
                const kickMessage = `*『 𝙰𝚄𝚃𝙾-𝙺𝙸𝙲𝙺 』*\n\n` +
                    `@${userToWarn.split('@')[0]} 𝚑𝚊𝚜 𝚋𝚎𝚎𝚗 𝚛𝚎𝚖𝚘𝚟𝚎𝚍 𝚏𝚛𝚘𝚖 𝚝𝚑𝚎 𝚐𝚛𝚘𝚞𝚙 𝚊𝚏𝚝𝚎𝚛 𝚛𝚎𝚌𝚎𝚒𝚟𝚒𝚗𝚐 𝟹 𝚠𝚊𝚛𝚗𝚒𝚗𝚐𝚜! ⚠️`;
