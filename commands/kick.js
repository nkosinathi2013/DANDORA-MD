...
async function kickCommand(sock, chatId, senderId, mentionedJids, message) {
    ...
    if (!isOwner) {
        ...
        if (!isSenderAdmin) {
            await sock.sendMessage(chatId, { text: '𝙾𝚗𝚕𝚢 𝚐𝚛𝚘𝚞𝚙 𝚊𝚍𝚖𝚒𝚗𝚜 𝚌𝚊𝚗 𝚞𝚜𝚎 𝚝𝚑𝚎 𝚔𝚒𝚌𝚔 𝚌𝚘𝚖𝚖𝚊𝚗𝚍.' }, { quoted: message });
            return;
        }
    }
    ...
    if (usersToKick.length === 0) {
        await sock.sendMessage(chatId, { 
            text: '𝙿𝚕𝚎𝚊𝚜𝚎 𝚖𝚎𝚗𝚝𝚒𝚘𝚗 𝚝𝚑𝚎 𝚞𝚜𝚎𝚛 𝚘𝚛 𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚝𝚑𝚎𝚒𝚛 𝚖𝚎𝚜𝚜𝚊𝚐𝚎 𝚝𝚘 𝚔𝚒𝚌𝚔!'
        }, { quoted: message });
        return;
    }
    ...
    try {
        ...
        await sock.sendMessage(chatId, { 
            text: `${usernames.join(', ')} 𝚑𝚊𝚜 𝚋𝚎𝚎𝚗 𝚏𝚞𝚌𝚔𝚎𝚍 𝚘𝚛 𝚔𝚒𝚌𝚔𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢!`,
