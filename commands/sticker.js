...
async function stickerCommand(sock, chatId, message) {
    ...
    if (!mediaMessage) {
        await sock.sendMessage(chatId, { 
            text: '𝙿𝚕𝚎𝚊𝚜𝚎 𝚛𝚎𝚙𝚕𝚢 𝚝𝚘 𝚊𝚗 𝚒𝚖𝚊𝚐𝚎/𝚟𝚒𝚍𝚎𝚘 𝚠𝚒𝚝𝚑 .𝚜𝚝𝚒𝚌𝚔𝚎𝚛, 𝚘𝚛 𝚜𝚎𝚗𝚍 𝚊𝚗 𝚒𝚖𝚊𝚐𝚎/𝚟𝚒𝚍𝚎𝚘 𝚠𝚒𝚝𝚑 .𝚜𝚝𝚒𝚌𝚔𝚎𝚛 𝚊𝚜 𝚝𝚑𝚎 𝚌𝚊𝚙𝚝𝚒𝚘𝚗.',
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
    ...
    try {
        ...
        const json = {
            ...
            'sticker-pack-name': settings.packname || '𝙳𝙰𝙽𝙳𝙾𝚁𝙰-𝙼𝙳',
            'emojis': ['🤖']
        };
